...
//        paymentRepository.findById(2L).get().getPaymentDetail().getCommissionAmount();

//        paymentRepository.delete(payment1); with cascade all it will delete paymentDetail1 too
